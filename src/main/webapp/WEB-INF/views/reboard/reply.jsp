...
$(document).ready(function() {
	$("#replyBtn").click(function() {
		if($("#subject").val() == "") {
			...
			$("#writeForm").attr("method", "post").attr("action", replypath).submit();
		}
	});
});
</script>
...
<table border="0" cellpadding="5" cellspacing="0" width="630"
	...
	<tr>
		<td width="620" nowrap style="padding-left: 8px; padding-top: 10px"
			...
			name="content" class="inp_02" cols="67" rows="25" scrollbars="no" id="content">
...
<table border="0" cellpadding="2" cellspacing="0" width="630">
	...
	<tr>
		<td align="center"><img
			...
			border="0" name="register" value="" alt="등록" id="replyBtn"> <a
