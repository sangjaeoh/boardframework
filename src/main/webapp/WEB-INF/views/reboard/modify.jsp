...
$(document).ready(function() {
   $("#registerBtn").click(function() {
      if($("#subject").val() == "") {
         ...
         $("#writeForm").attr("method", "post").attr("action", modifypath).submit();
      }
   });
});
...
<input type="hidden" name="pg" value="${bcode}">
...
<table border="0" cellpadding="2" cellspacing="0" width="630">
   ...
   <tr>
      <td align="center"><img
         ...
         border="0" name="registerBtn" id="registerBtn" alt="등록"><a href="javascript:history.back();"><img
