...
public class PageNavigation {
	...
	public void setNavigator() {
		...
		if (this.isNowFirst()) {
			...
			tmpNavigator.append("   <img src='" + root + "resources/board/img/board/icon_prev02.gif' width='7' height='11' border='0' align='absmiddle' hspace='3'>최신목록</a>\n");
			tmpNavigator.append("   <img src='" + root + "resources/board/img/board/img/board/icon_prev01_dim.gif' width='3' height='11' border='0' align='absmiddle' hspace='3'>\n");
			tmpNavigator.append("   이전</font>\n");
		} else {
			tmpNavigator.append("  <td>\n<a href='javascript:goPage(1)'>");
			tmpNavigator.append("   <img src='" + root + "resources/board/img/board/icon_prev02.gif' width='7' height='11' border='0' align='absmiddle' hspace='3'>최신목록 </a>\n");
			tmpNavigator.append("   <a href='javascript:goPage(페이지계산)'>");
			tmpNavigator.append("   <img src='" + root + "resources/board/img/board/icon_prev01_dim.gif' width='3' height='11' border='0' align='absmiddle' hspace='3'>\n");
		...
		for (int i = startPage; i <= endPage; i++) {
			if (pageNo == i) {
				...
				tmpNavigator.append("     <td width='1' nowrap><img src='" + root + "resources/board/img/board/n_tab.gif' width='1'");
				tmpNavigator.append(" height='11' border='0' align='absmiddle'><br>\n");
			} else {
		...
		if (this.isNowEnd()) {
			...
			tmpNavigator.append("   src='" + root + "resources/board/img/board/icon_next01_dim.gif' width='3' height='11'");
			tmpNavigator.append(" border='0' align='absmiddle' hspace='3'> \n");
			tmpNavigator.append("   끝목록<img src='" + root + "resources/board/img/board/icon_next02_dim.gif' width='7' height='11'");
			...
			tmpNavigator.append("   <a href='javascript:goPage(" + totalPageCount + ")'>끝목록<img src='" + root + "resources/board/img/board/icon_next02_dim.gif' width='7' height='11'");
			tmpNavigator.append(" border='0' align='absmiddle' hspace='3'>\n");
		}
